...
const CLOUD_PROVIDERS = [
  ...
  },
  {
    ...
    name: "SFTP / FTP",
    icon: "📁",
    color: "bg-default/10 text-foreground",
  },
  {
    id: "local",
    name: "Local Path",
          ...
          <div className="space-y-4">
            ...
            <Input
              ...
              onChange={(e) =>
                setWizard({
                  ...wizard,
                  config: { ...wizard.config, token: e.target.value },
                })
              }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setWizard({
                    ...wizard,
                    config: { ...wizard.config, access_key_id: e.target.value },
                  })
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setWizard({
                    ...wizard,
                    config: { ...wizard.config, region: e.target.value },
                  })
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setWizard({
                    ...wizard,
                    config: { ...wizard.config, host: e.target.value },
                  })
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setWizard({
                    ...wizard,
                    config: { ...wizard.config, user: e.target.value },
                  })
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setWizard({
                    ...wizard,
                    config: { ...wizard.config, pass: e.target.value },
                  })
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setWizard({
                    ...wizard,
                    config: { ...wizard.config, path: e.target.value },
                  })
                }
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setWizard({ ...wizard, config: { raw: e.target.value } })
                }
                placeholder="{}"
    ...
    <div className="flex flex-col h-full space-y-6">
      <div className="flex items-center gap-4 px-2 shrink-0">
        ...
        <div>
          ...
          <p className="text-xs text-muted">
            Manage remotes & upload destinations
          </p>
        </div>
      </div>
              ...
              <Card className="p-6 bg-background/50 border-border">
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-muted">
                    ...
                    completes. Leave empty to keep files local.
                  </p>
                </div>
              </Card>
            </section>
              ...
              {isLoading ? (
                ...
                <Card className="p-8 bg-background/50 border-border border-dashed">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-sm text-muted mb-6 max-w-md">
                      Add a cloud storage remote to enable file browsing and
                      automatic uploads after downloads complete.
                    </p>
                    <Button
                      variant="primary"
                      onPress={openWizard}
                ...
                <div className="space-y-3">
                  {remotes.map((remote: any) => {
                    const isDefault = defaultRemote.startsWith(
                      `${remote.name}:`,
                    );
                    return (
                      <Card
      ...
      <Modal.Backdrop isOpen={isWizardOpen} onOpenChange={setIsWizardOpen}>
        <Modal.Container>
            ...
            <Modal.Header className="p-6 pb-2">
              <Modal.Heading className="text-xl font-bold">
                ...
                {wizard.step === "configure" &&
                  `Configure ${wizard.provider?.name}`}
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <Input
                      value={wizard.name}
                      onChange={(e) =>
                        setWizard({ ...wizard, name: e.target.value })
                      }
                      placeholder={`my-${wizard.provider.id}`}
                      className="h-12 bg-default/10 rounded-2xl border-none"
                    />
                    <p className="text-xs text-muted mt-2">
                      This is how you'll refer to this remote (e.g.,{" "}
                      {wizard.name || `my-${wizard.provider.id}`}:)
                    </p>
                  </div>
              ...
              {wizard.step === "success" && (
                <div className="text-center py-6">
                  ...
                  <p className="text-lg font-bold mb-2">
                    "{wizard.name}" is ready to use!
                  </p>
                  <p className="text-sm text-muted">
                    You can now browse files and use this remote as an upload
                    destination.
                  </p>
                </div>
              )}
