...
import { Aria2Client } from "../../../lib/aria2-rpc";
...
export const ConnectionSettings: React.FC = () => {
  ...
  const handleTestConnection = async () => {
    ...
    try {
      ...
      const testClient = new Aria2Client(formData.rpcUrl, formData.rpcSecret);
                      ...
                      >
                        <div className="flex flex-col gap-0.5">
                          ...
                          <span className="text-xs text-muted">
                            Standard unencrypted connection (http://)
          ...
          <div className="bg-muted-background p-5 rounded-3xl border border-border space-y-5 shadow-sm">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                {version.enabledFeatures.map((feature: string) => (
                  <Chip
                    key={feature}
                    size="sm"
                    variant="soft"
