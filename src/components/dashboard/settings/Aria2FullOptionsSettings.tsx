...
export const Aria2FullOptionsSettings: React.FC<{
				...
				<div className="flex items-center justify-between gap-4">
					<div className="flex flex-col flex-1">
						<div className="flex items-center gap-2">
							<span className="font-mono text-small font-bold text-primary">
								{opt.name}
							</span>
							<Tooltip>
								<Tooltip.Trigger>
								...
								<Tooltip.Content className="max-w-xs p-2 text-tiny">
									{opt.description}
								</Tooltip.Content>
							</Tooltip>
						</div>
	...
	return (
		<div className="flex flex-col h-full space-y-4">
			...
			<ScrollShadow className="flex-1 pr-2 h-[450px]">
				<Accordion
				...
				>
					{filteredCategories.map((cat) => (
						<Accordion.Item key={cat} id={cat}>
							<Accordion.Heading>
								<Accordion.Trigger className="py-3 text-medium font-bold">
									{cat}
								</Accordion.Trigger>
							</Accordion.Heading>
							<Accordion.Panel>
