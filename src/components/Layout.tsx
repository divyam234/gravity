		...
		<div className="min-h-screen h-screen bg-background text-foreground flex overflow-hidden outline-none">
			...
			<div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
				...
				<header className="h-16 border-b border-border flex items-center justify-between px-4 md:px-8 bg-background shrink-0 gap-4">
                  ...
                  <IconServer className="w-3.5 h-3.5 text-accent shrink-0" />
                  <Select.Value className="text-[11px] font-black truncate uppercase tracking-wider text-foreground/80" />
                </div>*/}
								<Select.Value className="listbox-item hover:bg-transparent pr-5" />
							...
							>
								...
								<Alert.Content>
									...
									<Alert.Description className="text-sm opacity-90">
										Please configure your aria2 server connection to get
										started.
									</Alert.Description>
								</Alert.Content>
								<Button
