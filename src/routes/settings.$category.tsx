...
function SettingsPage() {
	...
	return (
		<div className="flex flex-col h-full space-y-6">
			...
			<div className="flex-1 bg-default-50/50 rounded-3xl border border-default-100 overflow-hidden min-h-0">
				<ScrollShadow className="h-full p-8 bg-background overflow-y-auto">
